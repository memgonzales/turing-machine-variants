	...
	function displayTestCase(value) {
		const lines = {
			...
			'axbxcx-non': [
				...
				'U2-L1Y1 ] U(1, 1, L1)',
				'; skip Z',
				'D1-L1Z1 ] D(1, 1, D2-L1Z1)',
				'D2-L1Z1 ] D(1, 1, D3-L1Z1)',
				'D3-L1Z1 ] D(#, #, U1-L1Z1)',
				'U1-L1Z1 ] U(1, 1, U2-L1Z1)',
				'U2-L1Z1 ] U(1, 1, U3-L1Z1)',
				'U3-L1Z1 ] U(1, 1, L1)',
				'; hit X',
				'D1-L1Y1 ] D(#, #, U1)',
				'U1 ] U(1, 1, R1)',
				...
				'U2-RlastY1 ] U(1, 1, R-last)',
				'; skip Z',
				'D1-RlastZ1 ] D(1, 1, D2-RlastZ1)',
				'D2-RlastZ1 ] D(1, 1, D3-RlastZ1)',
				'D3-RlastZ1 ] D(#, #, U1-RlastZ1)',
				'U1-RlastZ1 ] U(1, 1, U2-RlastZ1)',
				'U2-RlastZ1 ] U(1, 1, U3-RlastZ1)',
				'U3-RlastZ1 ] U(1, 1, R-last)',
				'',
				'; reject',
				'R2 ] R(c, c, reject)',
				'R2 ] R(#, #, reject)',
				'; hit Z',
				'R2 ] R(1, 1, D1-R2Z3)',
				'D1-R2Z3 ] D(1, 1, D2-R2Z3)',
				'D2-R2Z3 ] D(1, 1, reject)',
				'',
				'R3 ] R(a, a, reject)',
				'R3 ] R(#, #, reject)',
				'',
